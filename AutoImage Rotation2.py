...
img = cv2.imread('images/source/sketext.jpg',0)
...
edges = cv2.Canny(erosion, 150, 200, 3, 5, True)
...
def compute_skew(image):
    ...
    #cv2.imwrite('images/edges.png', edges)
    lines = cv2.HoughLinesP(edges, 1, 3.141592653589793/180, 100, minLineLength=width / 4.0, maxLineGap=10)
    angle = 0.0
    nlines = lines.size
...
deskewed_image = rotateImage2(erosion, compute_skew(erosion))
